...
<fmt:bundle basename="ressources_i18n.Messages_${locale}">
    ...
    <head>
        ...
        <title><fmt:message key="bookOutOfStock.title"/></title>
    ...
    <header>
        <div class="container-menu">
            <div class="menu-bar">
                ...
                <form method="get" action="BookOutOfStockServlet">
    ...
    <main>
        <h1><fmt:message key="bookOutOfStock.title"/></h1>
        <section class="section-block white-bg">
            <div class="text-block text-block-correct">
                <h3><fmt:message key="bookOutOfStock.message"/></h3>
                <a class="btn" href="CatalogServlet?locale=<%= locale %>"><fmt:message key="bookOutOfStock.buttonCatalog"/></a>
            </div>
        </section>
    </main>
    <footer>
