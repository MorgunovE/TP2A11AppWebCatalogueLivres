<%-- 
    Document   : basketError
    Created on : Dec 28, 2024, 1:57:44 PM
...
<fmt:bundle basename="ressources_i18n.Messages_${param.locale != null ? param.locale : 'en_US'}">
    ...
    <head>
        ...
        <title><fmt:message key="basketError.title"/></title>
    ...
    <header>
        <div class="container-menu">
            <div class="menu-bar">
                ...
                <form method="get" action="BasketErrorServlet">
    ...
    <main>
        <h1><fmt:message key="basketError.title"/></h1>
        <section class="section-block white-bg">
            <div class="text-block text-block-correct">
                <h3><fmt:message key="basketError.message"/></h3>
                <a class="btn" href="CatalogServlet?locale=<%= locale %>"><fmt:message key="basketError.buttonCatalog"/></a>
            </div>
        </section>
    </main>
    <footer>
