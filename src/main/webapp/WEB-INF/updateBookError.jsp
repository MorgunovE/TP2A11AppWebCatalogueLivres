<%-- 
    Document   : updateBookError
    Created on : Jan 7, 2025, 8:06:55 PM
...
<fmt:bundle basename="ressources_i18n.Messages_${locale}">
    ...
    <head>
        ...
        <title><fmt:message key="updateBookError.title"/></title>
    ...
    <header>
        <div class="container-menu">
            ...
            .equals(locale) ? "html/indexFR" : "index" %>.html"><img
                ...
                <form method="get" action="UpdateBookErrorServlet">
    ...
    <main>
        <h1><fmt:message key="updateBookError.title"/></h1>
        <section class="account-block white-bg">
            <div class="text-block text-block-correct">
                <h3><fmt:message key="updateBookError.message"/></h3>
                <a class="btn" href="AdminPortalServlet?locale=<%= locale %>"><fmt:message key="updateBookError.returnButton"/></a>
            </div>
        </section>
    </main>
    <footer>
