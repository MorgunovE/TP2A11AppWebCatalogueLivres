<%--
    Document   : updateBookSuccess
    Created on : Jan 7, 2025, 8:12:40 PM
...
<fmt:bundle basename="ressources_i18n.Messages_${locale}">
    ...
    <head>
        ...
        <title><fmt:message key="updateBookSuccess.title"/></title>
    ...
    <header>
        <div class="container-menu">
            ...
            .equals(locale) ? "html/indexFR" : "index" %>.html"><img
                ...
                <form method="get" action="UpdateBookSuccessServlet">
    ...
    <main>
        <h1><fmt:message key="updateBookSuccess.title"/></h1>
        <section class="account-block white-bg">
            <div class="text-block text-block-correct">
                <h3><fmt:message key="updateBookSuccess.message"/></h3>
                <a class="btn" href="AdminPortalServlet?locale=<%= locale %>"><fmt:message key="updateBookSuccess.returnButton"/></a>
            </div>
        </section>
    </main>
    <footer>
