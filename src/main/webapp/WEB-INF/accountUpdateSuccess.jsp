<%-- 
    Document   : accountUpdateSuccess
    Created on : Jan 14, 2025, 3:36:19 PM
...
<head>
    ...
    <title><fmt:message key="accountUpdateSuccess.title"/></title>
...
<body>
    <header>
        <div class="container-menu">
            <div class="menu-bar">
                ...
                <form method="get" action="AccountUpdateSuccessServlet">
    ...
    <main>
        <h1><fmt:message key="accountUpdateSuccess.title"/></h1>
        <section class="section-block white-bg">
            <div class="text-block text-block-card text-block-correct">
                <h3><fmt:message key="accountUpdateSuccess.message"/></h3>
                <div class="btn-basket">
                    <a class="btn" href="AccountPortalServlet?locale=<%= locale %>"><fmt:message key="accountUpdateSuccess.returnButton"/></a>
                </div>
            </div>
        </section>
    </main>
