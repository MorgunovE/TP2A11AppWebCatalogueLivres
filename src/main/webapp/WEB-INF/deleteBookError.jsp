<%-- 
    Document   : deleteBookError
    Created on : Jan 7, 2025, 7:00:33 PM
...
<fmt:bundle basename="ressources_i18n.Messages_${param.locale != null ? param.locale : 'en_US'}">
    ...
    <head>
        ...
        <title><fmt:message key="deleteBookError.title"/></title>
    ...
    <header>
        <div class="container-menu">
            <div class="menu-bar">
                ...
                <form method="get" action="DeleteBookErrorServlet">
    ...
    <main>
        <h1><fmt:message key="deleteBookError.title"/></h1>
        <section class="account-block white-bg">
            <div class="text-block text-block-correct">
                <h3><fmt:message key="deleteBookError.message"/></h3>
                <a class="btn" href="AccountPortalServlet?locale=<%= locale %>"><fmt:message key="deleteBookError.returnButton"/></a>
            </div>
        </section>
    </main>
    <footer>
